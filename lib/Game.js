...
module.exports = class Game {
  constructor(ctx) {
    ...
    this.paused = false;
    this.level = 1;
    this.player = new Player(280, 480, `./assets/images/bunny.png`);
    this.lanes = [
      {y: 440, direction: -1, speed: 1, img: `./assets/images/racecar.png`, width: 80},
      {y: 400, direction: 1, speed: .5, img: `./assets/images/dozer.png`, width: 80},
      {y: 360, direction: -1, speed: 1, img: `./assets/images/car.png`, width: 80},
      {y: 320, direction: 1, speed: 1.5, img: `./assets/images/fastcar.png`, width: 80},
      {y: 280, direction: -1, speed: .5, img: `./assets/images/truck.png`, width: 80},
      {y: 200, direction: -1, speed: 1.5, img: `./assets/images/lane_5_safe.png`, width: 120},
      {y: 160, direction: 1, speed: .5, img: `./assets/images/lane_6.png`, width: 120},
      {y: 120, direction: 1, speed: 1, img: `./assets/images/lane_7.png`, width: 240},
      {y: 80, direction: -1, speed: .5, img: `./assets/images/safeasteroid.png`, width: 80},
      {y: 40, direction: 1, speed: 1, img: `./assets/images/lane_9.png`, width: 160}
    ];
    this.obstacles = [
  ...
  restartGame() {
    ...
    this.resetObstacleSpeed();
    this.level = 1;
  }

  levelUp() {
    this.level++;
    this.player.farthest = 480;
  }
