...
module.exports = class Game {
  constructor(ctx) {
    ...
    this.lanes = [
      {y: 440, direction: -1, speed: 2, img: `${this.filePath}racecar.png`, width: 80, score: false},
      {y: 400, direction: 1, speed: 1, img: `${this.filePath}dozer.png`, width: 80, score: false},
      {y: 360, direction: -1, speed: 2, img: `${this.filePath}car.png`, width: 80, score: false},
      {y: 320, direction: 1, speed: 3, img: `${this.filePath}fastcar.png`, width: 80, score: false},
      {y: 280, direction: -1, speed: 1, img: `${this.filePath}truck.png`, width: 80, score: false},
      {y: 200, direction: -1, speed: 3, img: `${this.filePath}lane_5_safe.png`, width: 120, score: false},
      {y: 160, direction: 1, speed: 1, img: `${this.filePath}lane_6.png`, width: 120, score: false},
      {y: 120, direction: 1, speed: 2, img: `${this.filePath}lane_7.png`, width: 240, score: false},
      {y: 80, direction: -1, speed: 1, img: `${this.filePath}safeasteroid.png`, width: 80, score: false},
      {y: 40, direction: 1, speed: 2, img: `${this.filePath}lane_9.png`, width: 160, score: false}
    ];
    this.obstacles = [
