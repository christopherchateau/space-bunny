...
module.exports = class Game {
  constructor(ctx) {
    ...
    this.obstacles = [
      ...
      new Obstacle(520, 180, 40, this.lanes[6][2], this.lanes[6][0], this.lanes[6][1]),
      new Obstacle(320, 180, 40, this.lanes[6][2], this.lanes[6][0], this.lanes[6][1]),
      new Obstacle(120, 180, 40, this.lanes[6][2], this.lanes[6][0], this.lanes[6][1]),
    ];
