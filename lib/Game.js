...
module.exports = class Game {
  constructor(ctx) {
    ...
    this.lanes = [
      {y: 440, direction: -1, speed: 2, img: '/assets/images/racecar.png', width: 80, score: false},
      {y: 400, direction: 1, speed: 1, img: '/assets/images/dozer.png', width: 80, score: false},
      {y: 360, direction: -1, speed: 2, img: '/assets/images/car.png', width: 80, score: false},
      {y: 320, direction: 1, speed: 3, img: '/assets/images/fastcar.png', width: 80, score: false},
      {y: 280, direction: -1, speed: 1, img: '/assets/images/truck.png', width: 80, score: false},
      {y: 200, direction: -1, speed: 3, img: '/assets/images/lane_5_safe.png', width: 120, score: false},
      {y: 160, direction: 1, speed: 1, img: '/assets/images/lane_6.png', width: 120, score: false},
      {y: 120, direction: 1, speed: 2, img: '/assets/images/lane_7.png', width: 240, score: false},
      {y: 80, direction: -1, speed: 1, img: '/assets/images/safeasteroid.png', width: 80, score: false},
      {y: 40, direction: 1, speed: 2, img: '/assets/images/lane_9.png', width: 160, score: false}
    ];
    this.obstacles = [
  ...
  keepScore() {
    console.log(this.lanes, this.player.y)
  }
