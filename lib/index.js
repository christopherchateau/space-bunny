...
function gameLoop () {
  ...
  if (game.isOver()) {
    ...
    game.obstacles.forEach( obstacle => {
      if (game.player.isCollidingWith(obstacle) && obstacle.y >= 280) {
          console.log('die!!');
      }
      // else if (game.player.isCollidingWith(obstacle) === false && game.player.y <= 200) {
      //   console.log('splash');
      // }
      else if (game.player.isCollidingWith(obstacle) && obstacle.y < 280) {
